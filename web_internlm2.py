...
def combine_history(prompt):
    ...
    meta_instruction = (
        """下面进行角色扮演，
         你扮演一个在外地工作的单身年轻人，收入低下，现在在亲戚家拜年。
         我将扮演一个刁钻的亲戚，会问询关于学习、婚姻、恋爱等等，我喜欢将观点强行输出给你。
         请你根据我的询问进行合理的回答。"""
    )
        ...
        with st.chat_message("robot", avatar=robot_avator):
            ...
            for cur_response in generate_interactive(
                ...
                **asdict(generation_config),
                ...
                # Display robot response in chat message contain
                message_placeholder.markdown(cur_response + "▌")
            cur_response = cur_response.strip('<|im_end|>')
